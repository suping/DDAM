...
public class MethodAnalyzer {
	...
	/**
	 * 瀵逛簬宸插垎鏋愬嚭鐨勮烦杞強鍦ㄦ敼鐐硅鍔犲叆鐨勮烦杞俊鎭�
	 */
	...
	public void methodTransform(ClassNode cn,MethodNode mn) {
		         ...
		         if (mn.name.equals("accessServices")) {
//		        if (mn.name.equals("process")) {
			            //setEjbs(cn);			
...
//		stateMachine.getStates().add(0, stateMachine.getStart());
	...
	public void ExtractMetaData() {
		...
		// 涓や釜鏁扮粍鍒嗗埆瀛樻斁姣忎釜鐘舵�鐨刦uture鍜宲ast
		...
		// 棣栧厛浠庡墠鍒板悗閬嶅巻浜嬩欢鍒楄〃锛屼负姣忎竴涓姸鎬佹坊鍔爌ast锛屾�璺槸锛氬浜巗0-a1-s1杩欎竴浜嬩欢锛宻1鐨刾ast=a0+s0鐨刾ast
